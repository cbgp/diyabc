...
#
# Created: Tue May 17 14:22:33 2011
...
class Ui_TabWidget(object):
    def setupUi(self, TabWidget):
        ...
        self.nbHistParamLabel = QtGui.QLabel(self.frame_5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.nbHistParamLabel.sizePolicy().hasHeightForWidth())
        self.nbHistParamLabel.setSizePolicy(sizePolicy)
        self.nbHistParamLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.nbHistParamLabel.setObjectName(_fromUtf8("nbHistParamLabel"))
        self.horizontalLayout.addWidget(self.nbHistParamLabel)
        ...
        self.reftableProgressLabel = QtGui.QLabel(self.frame_3)
        self.reftableProgressLabel.setMinimumSize(QtCore.QSize(100, 0))
        self.reftableProgressLabel.setMaximumSize(QtCore.QSize(100, 16777215))
        self.reftableProgressLabel.setText(_fromUtf8(""))
        self.reftableProgressLabel.setObjectName(_fromUtf8("reftableProgressLabel"))
        self.horizontalLayout_3.addWidget(self.reftableProgressLabel)
        self.runReftableButton = QtGui.QPushButton(self.frame_3)
        self.runReftableButton.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.runReftableButton.setFont(font)
        self.runReftableButton.setObjectName(_fromUtf8("runReftableButton"))
        self.horizontalLayout_3.addWidget(self.runReftableButton)
        self.stopReftableButton = QtGui.QPushButton(self.frame_3)
        self.stopReftableButton.setMinimumSize(QtCore.QSize(60, 50))
        self.stopReftableButton.setMaximumSize(QtCore.QSize(60, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.stopReftableButton.setFont(font)
        self.stopReftableButton.setObjectName(_fromUtf8("stopReftableButton"))
        self.horizontalLayout_3.addWidget(self.stopReftableButton)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 929, 593))
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.nbHistParamLabel.setText(QtGui.QApplication.translate("TabWidget", "X parameters", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.runReftableButton.setText(QtGui.QApplication.translate("TabWidget", "Run computations", None, QtGui.QApplication.UnicodeUTF8))
        self.stopReftableButton.setText(QtGui.QApplication.translate("TabWidget", "Stop", None, QtGui.QApplication.UnicodeUTF8))
