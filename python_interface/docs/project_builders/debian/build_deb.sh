...
sed -i "s/VERSION='development version'/VERSION='v$VERSION'/" $PACKAGEDIR/usr/local/src/diyabc-$VERSION/diyabc.py
...
python /usr/local/src/diyabc-$VERSION/diyabc.py -title 'DIYABC $VERSION'" > $PACKAGEDIR/usr/local/bin/diyabc-$VERSION
