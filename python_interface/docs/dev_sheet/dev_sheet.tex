...
\section{Construction du projet}
    ...
    tel quel avec un dossier contenant des données.\\
...
Description: Repository of CBGP softwares \end{verbatim}
    ...
    if sys.platform.startswith(``darwin''): 
        ...
        package-mac-x64.sh . Il est à ajuster légèrement en fonction des chemins que l'on souhaite définir
        sur la machine utilisée. Il faut générer les packages sur les deux machines apple de Raphael.
