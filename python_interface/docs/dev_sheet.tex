...
\section{Construction du projet}
    ...
    \subsection{Windows}
        ...
        La troisème, py2exe est celle qui me semblait la plus viable mais pyinstaller 1.5 marche parfaitement.
    ...
    \subsection{MacOs 10.6 Snow Leopard}
        ...
        Pour installer numpy correctement, ajouter l'option -atlas à la commande port.
