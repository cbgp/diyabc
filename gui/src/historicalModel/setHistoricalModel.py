...
class SetHistoricalModel(formHistModel,baseHistModel):
    ...
    def addCondition(self,cond_str=""):
        ...
        groupBox_cond.setMinimumSize(QtCore.QSize(0, 44))
        groupBox_cond.setMaximumSize(QtCore.QSize(300, 44))
        ...
        label_2.setMinimumSize(QtCore.QSize(0, 11))
        label_2.setMaximumSize(QtCore.QSize(300, 11))
        ...
        verticalLayout_2.setAlignment(QtCore.Qt.AlignVCenter)
        # ajout dans la GUI
